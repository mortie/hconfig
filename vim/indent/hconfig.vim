...
" Heavily based on the JSON indent file.
...
setlocal indentexpr=GetHcnfIndent()
setlocal indentkeys=0{,0},0),0[,0],!^F,o,O,e

" Only define the function once.
if exists("*GetHcnfIndent")
  finish
endif
...
function s:IsInString(lnum, col)
  return synIDattr(synID(a:lnum, a:col, 1), 'name') == 'hcnfString'
endfunction
...
" 3. GetHcnfIndent Function {{{1
" =========================

function GetHcnfIndent()
  " 3.1. Setup {{{2
  " ----------
